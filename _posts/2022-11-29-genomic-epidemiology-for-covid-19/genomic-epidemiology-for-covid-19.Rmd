...
It was a pleasure to join the University of Pennsylvania's 'Parallel Plagues' course this week. My presentation is linked below:       
  
  
```{r xaringan_empty_islands, eval=TRUE, warning=FALSE, message=FALSE, echo=FALSE}

xaringanExtra::embed_xaringan(url = "https://bjklab.github.io/Parallel-plagues/covid_genomic_epi_slides.html",
                              ratio = "16:9")
